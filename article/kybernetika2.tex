...
to speed of light $c\approx 3\dot 10^{9} m/s$. Time of arrival is recoded when
...
\end{figure}
As can be observed on plots presented on Figure \ref{fig:error_oveview} there are satellites
...
\ref{fig:relative_error_comarition}. Proposed solution is capable of providing results 
